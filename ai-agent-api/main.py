...
from app.infrastructure.redis_client import RedisClientManager
...
async def lifespan(app: FastAPI) -> AsyncGenerator:
    ...
    anthropic_info = 'configured' if settings.anthropic_api_key else 'NOT configured'
    logger.info(f"Anthropic API: {anthropic_info}")
    ...
    try:
        ...
        # Don't fail startup if Redis fails, but log it
        # In production, you might want to fail startup if Redis is critical
